...
def render_ceph_component(image_data_url: str, marker_size: int, show_labels: bool, point_state: dict):
    ...
    <style>
      ...
      #coord-stack{
        margin-top:8px;padding-top:6px;border-top:1px solid rgba(255,255,255,.18);
    ...
    <script>
      ...
      (function(){
        ...
        const angleRowMap = Object.fromEntries(
          angleRows.map(r => [r.dataset.angle, {row:r, valueEl:r.querySelector(".angle-value")}])
        );
        ...
        const computeAngle=(pairA,pairB)=>{
          const a1=markerById[pairA[0]], a2=markerById[pairA[1]],
                b1=markerById[pairB[0]], b2=markerById[pairB[1]];
